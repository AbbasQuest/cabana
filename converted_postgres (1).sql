...
CREATE TABLE "pricing" (
  ...
  "discount_per_passenger" int(11) NOT NULL,
...
--
ALTER TABLE "admin"
  MODIFY "id" int(11) NOT NULL , =3;

--
--  for table "bookings"
--
ALTER TABLE "bookings"
  MODIFY "id" int(255) NOT NULL , =16;

--
--  for table "coupons"
--
ALTER TABLE "coupons"
  MODIFY "id" int(11) NOT NULL , =33;

--
--  for table "coupon_usage"
--
ALTER TABLE "coupon_usage"
  MODIFY "id" int(11) NOT NULL , =23;

--
--  for table "menu"
--
ALTER TABLE "menu"
  MODIFY "id" int(255) NOT NULL , =33;

--
--  for table "orders"
--
ALTER TABLE "orders"
  MODIFY "id" int(255) NOT NULL , =14;

--
--  for table "order_items"
--
ALTER TABLE "order_items"
  MODIFY "id" int(255) NOT NULL , =21;
...
--
ALTER TABLE "pricing"
  MODIFY "id" int(11) NOT NULL , =68;

--
--  for table "queries"
--
ALTER TABLE "queries"
  MODIFY "id" int(11) NOT NULL , =9;

--
--  for table "slots"
--
ALTER TABLE "slots"
  MODIFY "id" int(255) NOT NULL , =12;

--
--  for table "user"
--
ALTER TABLE "user"
  MODIFY "id" int(10) NOT NULL , =61;

--
--  for table "user_payment_details"
--
ALTER TABLE "user_payment_details"
